      ...
      <div style={{ padding: '40px 20px 40px', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <McPanel style={{ flex: '1 1 180px', minWidth: 0, maxWidth: '260px', padding: '20px 16px', textAlign: 'center', boxSizing: 'border-box', overflowWrap: 'break-word' }}>
            ...
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 'clamp(0.8rem, 2.5vw, 1rem)', color: '#e5e5e5', textShadow: '1px 1px 0 #000', lineHeight: '1.6', wordBreak: 'break-word' }}>{process.env.NEXT_PUBLIC_EVENT_VENUE || 'TP 2 711'}</p>
          </McPanel>
