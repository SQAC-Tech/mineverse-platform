        ...
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl px-4">
          <div className="flex-1 w-full max-w-sm mx-auto">
            <MinecraftBoard title="Faculty Convenor">
              <p className="text-xl text-[#8b0000] font-bold mt-2">M Suganiya</p>
            </MinecraftBoard>
          </div>
          
          <div className="flex-1 w-full max-w-sm mx-auto">
            <MinecraftBoard title="Secretaries">
              <div className="space-y-4 mt-2">
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-bold text-[#006400]">Agrim</span>
                  <span className="text-[#3c2512] font-bold text-sm">[Number Needed]</span>
                </div>
              </div>
            </MinecraftBoard>
          </div>
